      ...
      <header className="relative border-b border-slate-900">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
          <SectionTitle
            ...
            subtitle="Procurement-friendly overview: deployment models, support posture, evaluation checklist, and security review shortcuts."
          />
          <div className="mt-10 max-w-4xl mx-auto rounded-2xl border border-slate-900 bg-slate-950/60 p-6">
            ...
            <p className="mt-2 text-sm text-slate-300 leading-relaxed">
              TealTiger is SDK-first and designed to run inside your environment. By default it does not persist prompts/outputs; it emits
              structured enforcement metadata for your SOC and observability pipelines.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="mt-10 grid lg:grid-cols-3 gap-6">
          ...
          <Card
            ...
            items={[
              'Works with private egress and allowlist controls',
        ...
        <div className="mt-12 grid lg:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-slate-900 bg-slate-950/60 p-6">
            ...
            <ul className="mt-4 space-y-2 text-sm text-slate-300">
              <li className="flex gap-2"><span className="mt-[0.35rem] h-1.5 w-1.5 rounded-full bg-teal-400/80" />Community support via GitHub issues and discussions</li>
              <li className="flex gap-2"><span className="mt-[0.35rem] h-1.5 w-1.5 rounded-full bg-teal-400/80" />Security disclosures via SECURITY.md process</li>
              <li className="flex gap-2"><span className="mt-[0.35rem] h-1.5 w-1.5 rounded-full bg-teal-400/80" />Enterprise coordination via email (reachout@tealtiger.ai)</li>
            </ul>
          </div>
          ...
          <div className="rounded-2xl border border-slate-900 bg-slate-950/60 p-6">
            ...
            <p className="mt-2 text-sm text-slate-300 leading-relaxed">
              Public pages do not constitute a contractual SLA. Any SLA targets (uptime, response times, support hours) are only binding
              when explicitly agreed in writing.
            </p>
            <div className="mt-4 rounded-xl border border-slate-900 bg-slate-950 p-4">
              <div className="text-xs text-slate-400">Practical guidance</div>
              <div className="mt-1 text-sm text-slate-300">Use the evaluation checklist below to accelerate internal approval.</div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12">
          ...
          <div className="mt-6 grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <ChecklistItem title="Data handling" desc="Verify that prompts/outputs are not persisted by default; confirm what metadata is emitted and where it is routed." />
            ...
            <ChecklistItem title="Access & secrets" desc="Confirm secrets handling patterns (env vars, secrets manager, Vault) and least-privilege permissions." />
            <ChecklistItem title="Observability" desc="Confirm OpenTelemetry compatibility and integration with logs/metrics/traces." />
            <ChecklistItem title="Change management" desc="Confirm versioning, upgrade approach, and rollback strategy in your deployment pattern." />
          </div>
